...
- No entanto, podemos melhorar esse código ao adicionar um método chamado checkIn na nossa entidade Starship, veja abaixo:
```php
...
- Alterando na classe ShipCheckInCommand, temos o seguinte código:
```php
<?php
